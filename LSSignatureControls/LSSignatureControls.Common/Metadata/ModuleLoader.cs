...
using LSSignatureControls.Resources;

namespace LSSignatureControls.Metadata
{
    [Export(typeof(IModuleDefinitionLoader))]
    [ModuleDefinitionLoader("LSSignatureControls")]
    internal class ModuleLoader : IModuleDefinitionLoader
    {
